...
export default class BoykisserConverter extends Converter {
    constructor() {
        super({
            acceptsFileTypes: [FileType.TXT],
            canConvertToFileTypes: [FileType.TXT],
            name: "Boy Kisser Converter",
            description: ":3"
        })
    }

    public override async convert(oldContent: Content, options: ConverterConvertOptions, passThrough: never): Promise<Content> {
